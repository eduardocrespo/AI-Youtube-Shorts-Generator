...
def crop_to_vertical(input_video_path, output_video_path):
    ...
    for _ in range(total_frames):
        ...
        x, y, w, h = 0, 0, vertical_width, vertical_height  # Default crop area
        ...
        if len(faces) >-1:
            if len(faces) == 0:
                try:
                    ...
                    print(f"No data in Frames for count {count}. Using default crop area.")
            else:  # Si se detectan caras
                # (x, y, w, h) = faces[0]  
                try:
            ...
            '''
            # print(faces[0])
            centerX = x + (w // 2)  # Esta línea ahora estará garantizada
